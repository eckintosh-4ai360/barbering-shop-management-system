...
type FieldDef = { key: string; label: string; hint?: string; type?: "text" | "textarea" | "url"; span?: 2 };
...
const SECTIONS: { title: string; description: string; icon: React.ElementType; fields: FieldDef[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "heroImageUrl", label: "Hero Image URL", type: "url", span: 2 },
    ],
  },
  {
        ...
        {SECTIONS.map((section) => {
          ...
          return (
            <div key={section.title} className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-sm space-y-5">
              ...
              {section.title === "Homepage Hero Section" && form.heroImageUrl && (
